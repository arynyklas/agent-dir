...
This is the only indicator of AI involvement that should NOT appear in commits. Do not add phrases like "Generated by AI", "Written with Claude", or similar markers in the subject, body, or anywhere else in the commit message. But still include main author attribution to the user who initiated the commit.
